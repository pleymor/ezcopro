...
// Note: We create a simplified version for Storybook since the actual page
// depends on Firebase Auth which isn't available in Storybook
...
const meta: Meta<typeof LoginPageMock> = {
  title: 'Pages/Login',
