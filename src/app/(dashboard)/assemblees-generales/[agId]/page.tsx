    ...
    <div className="container mx-auto max-w-4xl px-4 py-8">
      ...
      <div className="grid gap-4 md:grid-cols-2">
        <Card>
          ...
          <CardContent>
            <Link href={`/assemblees-generales/${agId}/ordre-du-jour`}>
        ...
        <Card>
          ...
          <CardContent>
            <Link href={`/assemblees-generales/${agId}/presence`}>
        ...
        {ag.statut === 'en_cours' && (
          <Card>
            ...
            <CardContent>
              <Link href={`/assemblees-generales/${agId}/votes`}>
                <Button className="w-full" variant="outline">
                  Gérer les votes
                </Button>
              </Link>
